...
import { useNavigate } from "react-router-dom"; // Use the correct hook for navigation

export default function FormOrders() {
  const [formData, setFormData] = useState({
    OrderID: "",
    CustomerID: "",
    OrderDate: new Date().toISOString().split("T")[0], // Default to the current date
    Product: "",
  ...
  const handleSubmit = (e) => {
    ...
    // Redirect to the orders list page after submission
    navigate("/orders"); // Navigate to /orders after successful submission
  };
